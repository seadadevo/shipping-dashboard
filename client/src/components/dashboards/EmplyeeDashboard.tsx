...
export function EmployeeDashboard() {
  ...
  const merchantsCount = useMemo(() => {
    return users.reduce(
      (acc, u) => acc + (u.userType?.toLowerCase() === "merchant" ? 1 : 0),
      0
    );
  }, [users]);
  ...
  const { ordersRate, allProcessingOrders, allRecentOrders, orderStatuses } =
    useMemo(() => {
      let delivered = 0;
      let processing = 0;
      let pending = 0;
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">تحتاج تدخل النظام</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">تاجر نشط اليوم</p>
          </CardContent>
        </Card>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>آخر خمس طلبات تم ادخالها في النظام</CardDescription>
        </CardHeader>
        <CardContent>
        ...
        <Card className="border-blue-200 bg-blue-50">
          ...
          <CardContent>
            ...
            >
              ...
              معالجة{" "}
              {orderStatuses.find((s) => s.id === "processing")?.count || 0} طلب
            </Button>
          </CardContent>
        </Card>
        ...
        <Card className="border-orange-200 bg-orange-50">
          ...
          <CardContent>
            ...
            >
              ...
              متابعة {orderStatuses.find((s) => s.id === "pending")?.count ||
                0}{" "}
              طلب
            </Button>
          </CardContent>
